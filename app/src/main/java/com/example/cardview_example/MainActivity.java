...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1
        first_Course.add(new Course("길에서 맛보는 부산여행의 묘미", "푸디 투어",
        ...
        // 2
        first_Course.add(new Course("맛의 핫플! 초량 돼지갈비 골목 & 불백 거리", "푸디 투어",
        ...
        //3
        first_Course.add(new Course("낭만 추억 만들어 주는 해운대 포장마차", "푸디 투어",
